...
// Steps
// 1. Find the 2 lowest positive numbers
// 2. Add them and give their sum as the output
...
function sumTwoSmallestNumbers(numbers) {  
    ...
    let smallestSum = check.splice(0, 2)
  
    
    let adding = smallestSum.reduce((total, curr) => total + curr, 0)
    return `Sum should be ${adding}`
